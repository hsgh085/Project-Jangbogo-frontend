...
const BarcordScanner = () => {
  ...
  /** 바코드 관련 상태변수 */
  // 예시: 8801019005909
  const [barcode, setBarcode] = useState('8801043034562');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flex: 1, justifyContent: 'center', marginVertical: 20 }}>
        <Text style = {{fontSize: 22, fontWeight: 'bold', textAlign: 'center'}}>바코드를 카메라에 위치시킨 후 </Text>
        <Text style = {{fontSize: 22, fontWeight: 'bold', textAlign: 'center'}}>바코드 스캔하기 버튼을 눌러주세요</Text>
